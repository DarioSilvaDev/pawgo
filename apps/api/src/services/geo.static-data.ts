// Archivo autogenerado por scripts/generate-static-ciudades.mjs
...
export const STATIC_CIUDADES_BY_PROVINCIA: Record<string, StaticCiudadDTO[]> = {
  "10": [
    {
      "id": "100042",
      "nombre": "Aconquija",
  ...
  "86": [
    {
      ...
      "nombre": "Abra Grande",
      "provinciaId": "86",
      "provinciaNombre": "Santiago del Estero"
    },
    {
      "id": "86119010",
      "nombre": "Aerolito",
